 ...
 * This differs from a player object, which is a representation of one of the players in the game.
...
public class User {
    ...
    /**
     * Creates a User object. Should only be called in the DatabaseConnection class as it requires the UID of the
     * user from the database
     * 
     * @param userUID The unique identifier of the user in the MySQL database
     * @param userName The name of the user
     * @param settings A string representing various settings as stored in the database.
     */
    ...
    /**
     * Gets the user's UID. Used for methods connecting to the database to retrieve linked records.
