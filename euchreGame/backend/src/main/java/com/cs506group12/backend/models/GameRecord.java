...
public class GameRecord {
     ...
     * @param players   A String array of size 4 consisting of the usernames of the
     *                  players in the game.
     * @param score     An int array of size 2 consisting of the scores of teams 1
     ...
     * 
     * @param teamNumber The identifying number (1 or 2) of the team from which to
     *                   get the players.
     * @return String array of size 2 with the names of the players on the given
     *         team
     */
     ...
     * 
     * @param teamNumber The identifying number (1 or 2) of the team whose scores
     *                   should be returned.
     ...
     * @return The team number the player was on. -1 if the player was not found on
     *         a team.
     */
