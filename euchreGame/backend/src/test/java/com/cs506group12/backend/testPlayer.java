...
// assertEquals(new Card(Card.SUIT.DIAMONDS, 14),
// p.getHighCardofSuit(Card.SUIT.DIAMONDS));
// }
...
// assertEquals(new Card(Card.SUIT.CLUBS, 9),
// p.getLowCardOfSuit(Card.SUIT.CLUBS));
// }
...
// boolean[] playable = test.getPlayableCards(Card.SUIT.HEARTS,
// Card.SUIT.CLUBS);
...
// boolean[] playable = test.getPlayableCards(Card.SUIT.DIAMONDS,
// Card.SUIT.CLUBS);
