  ...
  return (
    <div className="bg-red-500 h-screen border-2 border-black mt-2">
      ...
      <div className="mb-2 block">
        ...
        />
        <label className="ml-2 cursor-pointer" htmlFor="radioDefault01">
          1 Player
        </label>
      </div>
      <div className="mb-2 block">
        <input
          ...
          onChange={handlePlayerChange}
        />
        <label className="ml-2 cursor-pointer" htmlFor="radioDefault02">
          2 Players
        </label>
      </div>
      <div className="mb-2 block">
        <input
          ...
          onChange={handlePlayerChange}
        />
        <label className="ml-2 cursor-pointer" htmlFor="radioDefault03">
          3 Players
        </label>
      </div>
      <div className="mb-2 block">
        <input
          ...
          onChange={handlePlayerChange}
        />
        <label className="ml-2 cursor-pointer" htmlFor="radioDefault04">
          4 Players
        </label>
      </div>
      ...
      <div className="m-3 block">
        <label htmlFor="timePerTurn1" className="mr-2">
      ...
      {/* setting for number of points a player needs to win */}
      <div className="m-3 block">
        <label htmlFor="pointsToWin" className="mr-2">
          Points To Win:
        </label>
        <input
          type="text"
      ...
      <div className="m-3 block">
        <label htmlFor="roundsToWin" className="mr-2">
          Number Of Rounds:
        </label>
        <input
          type="text"
